<x-app-layout>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex flex-row justify-content-between">
                                    ...
                                    <div class="p-1">
                                        <button class="btn btn-primary btn-sm " data-bs-toggle="modal" data-bs-target="#modalAddBahanBaku">Tambah</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex flex-row justify-content-between">
                                    ...
                                    <div class="p-1">
                                        <button class="btn btn-primary btn-sm " data-bs-toggle="modal" data-bs-target="#modalAddProduk">Tambah</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
    ...
    {{-- add bahan baku --}}
    <div class="modal fade" id="modalAddBahanBaku" tabindex="-1" role="dialog" aria-labelledby="modalAddBahanBakuLabel"
        aria-hidden="true">
